...
class EngineTest: XCTestCase {
    ...
    func testPreviousFinal() throws {
        ...
        XCTAssertEqual(r6?[1].input, "r")
        XCTAssertEqual(r6?[1].output, "र")
        XCTAssertEqual(r6?[1].isPreviousFinal, true)
    }
    ...
    func testMappedNoOutput() throws {
        ...
        XCTAssertEqual(r5?[1].isPreviousFinal, true)
    ...
    func testMappingOutputMappingOutputMappingOutput() throws {
        ...
        XCTAssertEqual(r2?[1].isPreviousFinal, true)
